...
DEFAULT_PROJECT = 'counterfactual-dpg'

# Key metrics for comparison (from RECOMMENDED_METRICS)
# Note: WandB uses 'combo_metrics/' and 'metrics/' prefixes
COMPARISON_METRICS = {
    'perc_valid_cf': {
        'name': 'Validity (%)',
        'goal': 'maximize',
        ...
        'format': '.2%',
        'wandb_keys': ['combo_metrics/perc_valid_cf', 'metrics/perc_valid_cf'],
    },
    'plausibility_sum': {
        'name': 'Plausibility',
        'goal': 'minimize',
        ...
        'format': '.3f',
        'wandb_keys': ['combo_metrics/plausibility_sum', 'metrics/plausibility_sum'],
    },
    'distance_l2': {
        'name': 'Distance (L2)',
        'goal': 'minimize',
        ...
        'format': '.3f',
        'wandb_keys': ['combo_metrics/distance_l2', 'metrics/distance_l2', 'metrics/distance_euclidean'],
    },
    'distance_mad': {
        'name': 'Distance (MAD)',
        'goal': 'minimize',
        ...
        'format': '.3f',
        'wandb_keys': ['combo_metrics/distance_mad', 'metrics/distance_mad'],
    },
    'avg_nbr_changes_per_cf': {
        ...
        'format': '.2f',
        'wandb_keys': ['combo_metrics/avg_nbr_changes_per_cf', 'metrics/avg_nbr_changes_per_cf', 
                       'combo_metrics/avg_nbr_changes', 'metrics/num_feature_changes', 'metrics/sparsity'],
    },
    'diversity_l2': {
        'name': 'Diversity',
        'goal': 'maximize',
        ...
        'format': '.3f',
        'wandb_keys': ['combo_metrics/diversity_l2', 'metrics/diversity_l2'],
    },
    'perc_valid_actionable_cf': {
        ...
        'format': '.2%',
        'wandb_keys': ['combo_metrics/perc_valid_actionable_cf', 'metrics/perc_valid_actionable_cf'],
    },
    'accuracy_knn_sklearn': {
        ...
        'format': '.2%',
        'wandb_keys': ['combo_metrics/accuracy_knn_sklearn', 'metrics/accuracy_knn_sklearn', 
                       'combo_metrics/accuracy_knn_dist'],
    },
    'delta': {
        'name': 'Δ Prediction',
        'goal': 'maximize',
        ...
        'format': '.3f',
        'wandb_keys': ['combo_metrics/delta', 'metrics/delta'],
    },
}
