                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        for feat in numeric_features:
                                            if feat in feature_df.columns:
                                                feature_variance[feat] = feature_df[
                                                    feat
                                                ].var()
                                        ...
                                        max_pairplot_features = (
                                            5  # Limit for readability
                                        )
                                        pairplot_features = [
                                            feat
                                            for feat, _ in sorted_by_variance[
                                                :max_pairplot_features
                                            ]
                                        ]
                                        ...
                                        if len(pairplot_features) >= 2:
                                            ...
                                            pairplot_df["point_type"] = (
                                                pairplot_df.apply(
                                                    get_point_type, axis=1
                                                )
                                            )
                                            ...
                                            hue_order = [
                                                h
                                                for h in full_hue_order
                                                if h in actual_point_types
                                            ]
                                            palette = {
                                                k: full_palette[k] for k in hue_order
                                            }
                                            markers = [
                                                full_markers[k] for k in hue_order
                                            ]
                                            ...
                                            plt.close(g.fig)
                                            print(
                                                f"INFO: Successfully saved seaborn pairplot to {pairplot_path}"
                                            )
                                        else:
                                            print(
                                        ...
                                        print(
                                            f"ERROR: Failed to create seaborn pairplot: {exc}"
                                        )
                                        traceback.print_exc()
                                    ...
                                    try:
                                        if final_cf and len(features_for_radar) > 0:
                                            ...
                                            original_values = [
                                                ORIGINAL_SAMPLE.get(f, 0)
                                                for f in categories
                                            ]
                                            cf_values = [
                                                final_cf.get(f, 0) for f in categories
                                            ]
                                            ...
                                            max_val = (
                                                max(all_values) if all_values else 1
                                            )
                                            value_range = (
                                                max_val - min_val
                                                if max_val > min_val
                                            ...
                                            for idx, (
                                                ...
                                                if orig_min is not None:
                                                    orig_min_real = orig_constraints[
                                                        categories[idx]
                                                    ]["min"]
                                                    ax_radar.text(
                                                        angle,
                                                ...
                                                if orig_max is not None:
                                                    orig_max_real = orig_constraints[
                                                        categories[idx]
                                                    ]["max"]
                                                    ax_radar.text(
                                                        angle,
                                            ...
                                            handles, labels = (
                                                ax_radar.get_legend_handles_labels()
                                            )
                                            ...
                                            plt.close(fig_radar)
                                            print(
                                                f"INFO: Successfully saved radar chart"
                                            )
                                        else:
                                            print(
                                        ...
                                        print(
                                            f"ERROR: Failed to save radar chart: {exc}"
                                        )
                                        traceback.print_exc()
